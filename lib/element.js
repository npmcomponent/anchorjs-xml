...
define(function() {
  ...
  Element.prototype.name = function() {
    // FIXME: I believe this should be localName
   ...
   * @api public
   */
  Element.prototype.child = function(name, ns) {
  ...
  Element.prototype.children = function(name, ns) {
    ...
    while (child) {
      var childNS = child.namespaceURI || child.getAttribute('xmlns');
      if ((!name || name === child.nodeName) && (!ns || ns === childNS)) {
